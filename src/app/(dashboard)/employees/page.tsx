...
export default async function EmployeesPage({
  ...
  const { employees, total } = await getEmployees(search, page, pageSize);
    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-zinc-600 mt-1">Manage and track company staff members across departments.</p>
        </div>
